  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "soft-md": "0 4px 12px -2px rgb(0 0 0 / 0.04), 0 2px 6px -2px rgba(59, 130, 246, 0.06)",
        "soft-lg": "0 8px 30px rgb(0 0 0 / 0.04), 0 4px 12px rgba(59, 130, 246, 0.08)",
        "soft-xl": "0 12px 40px -8px rgb(0 0 0 / 0.06), 0 8px 20px -6px rgba(59, 130, 246, 0.10)",
        "premium": "0 8px 30px rgb(0 0 0 / 0.04), 0 4px 12px rgba(59, 130, 246, 0.08)",
        "premium-lg": "0 12px 40px -8px rgb(0 0 0 / 0.06), 0 6px 16px rgba(59, 130, 246, 0.10)",
      },
    },
  },
