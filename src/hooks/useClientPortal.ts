...
export function useClientPortal() {
  ...
  return {
    ...
    uploadVenueMenu: uploadVenueMenuMutation.mutateAsync,
    uploadVenueLogo: uploadVenueLogoMutation.mutateAsync,
    uploadVenueAdditionalLogo: uploadVenueAdditionalLogoMutation.mutateAsync,
    uploadVenueLayout: uploadVenueLayoutMutation.mutateAsync,
