...
/**
 * PortalAdmin - Admin client picker page at /admin/portal.
 * 
 * When a client is selected from the switcher, navigates to
 * /admin/portal/:clientSlug to view their portal.
 */
